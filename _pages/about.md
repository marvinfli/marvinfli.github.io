...
I'm an AI researcher working at the intersection of theory and practice. My past resesarch has focused on the **science and theory of generative models** and developing methods to enhance the **capabilities and safety of language models**. I've had the privilege of collaborating with [Prof. Sitan Chen](https://sitanchen.com/) and [Prof. Seth Neel](https://sethneel.com/). Earlier this year, I graduated *summa cum laude* with highest honors from Harvard with a B.A. in Computer Science & Mathematics.
